...
def step_impl(context, caminho, nome_stack):
    session = boto3.Session(aws_access_key_id=context.aws_access_key_id, aws_secret_access_key=context.aws_secret_access_key,
                            region_name=context.aws_default_region, aws_session_token=context.aws_access_token)
...
def step_implt(context):
    ...
    while stack_status != 'CREATE_COMPLETE' or count < 4:
